...
test("ProductTerms.compare: mathNodeToProductTerm compare", () => {
  ...
  expect(n(`x`).bigOh(n(`x`))).toBeTruthy()
  expect(n(`x`).bigOh(n(`x^2`))).toBeTruthy()
  expect(n(`x^2`).bigOh(n(`x`))).toBeFalsy()
  expect(n(`x`).oh(n(`x`))).toBeFalsy()
  expect(n(`x`).oh(n(`x^2`))).toBeTruthy()
  expect(n(`x`).bigOh(n(`log(x)`))).toBeFalsy()
  expect(n(`log(x)^10`).bigOh(n(`x`))).toBeTruthy()
  expect(n(`-log(x)^10`).bigOh(n(`x`))).toBeTruthy()
  expect(n(`log(x)^10`).oh(n(`x`))).toBeTruthy()
  expect(n(`log(x)^10`).bigTheta(n(`x`))).toBeFalsy()
  expect(n(`-log(x)^10`).bigOmega(n(`-x`))).toBeTruthy()
  ...
  expect(n(`3 x^2 + 7 x^2`).bigTheta(n(`(2 x) * (5 x)`))).toBeTruthy()
  expect(n(`3 x^2 - 7 x`).bigTheta(n(`x^2`))).toBeTruthy()
  expect(n(`3 x^2 - 7 x`).bigTheta(n(`x`))).toBeFalsy()
  expect(n(`3 x^2 - x^3`).bigTheta(n(`x^2`))).toBeFalsy()
  expect(n(`3 x^2 - 2 x^2`).bigTheta(n(`x^2`))).toBeTruthy()
  expect(n(`3 x^2 - 3 x^2`).bigTheta(n(`x^2`))).toBeFalsy()
  expect(n(`x^7`).bigOh(n(`2^x`))).toBeTruthy()
  ...
  expect(n(`3^(log_3(x))`).bigTheta(n(`x`))).toBeTruthy()
