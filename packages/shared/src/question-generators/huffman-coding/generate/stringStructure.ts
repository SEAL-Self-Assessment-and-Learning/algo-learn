...
import { getHuffmanCodeOfWord, type HuffmanNode } from "../Huffman.ts"
import { insertSpaceAfterEveryXChars } from "../utils/utils.ts"
import {
  flip01InCodeChar,
  ...
  reduceCodeOfLetter,
  switchLetters,
} from "./answerOptions.ts"
import { generateString } from "./words.ts"
