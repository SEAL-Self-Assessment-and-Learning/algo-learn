import type { MultiFreeTextQuestion, QuestionGenerator } from "../../api/QuestionGenerator.ts"
...
import { mdTableFromData } from "../../utils/markdownTools.ts"
import type { ColumnAlignment } from "../../utils/parseMarkdown.ts"
