...
import {
  ...
  HeapProofs,
  HeapUnderstanding,
} from "@shared/question-generators/heap/heapGenerator.ts"
import { huffmanCoding } from "@shared/question-generators/huffman-coding/huffmanCoding.ts"
...
export const allQuestionGeneratorRoutes: QuestionRoutes = [
  ...
  {
    path: "heap/heapOperation",
    generator: HeapOperations,
  },
  {
    path: "heap/heapUnderstanding",
    generator: HeapUnderstanding,
  },
  {
    path: "heap/heapProof",
    generator: HeapProofs,
  },
]
