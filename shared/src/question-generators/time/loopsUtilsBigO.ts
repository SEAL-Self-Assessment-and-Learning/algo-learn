 ...
 *            - variable: the name of the variable that determines the runtime
 ...
 * Question is generated by using code snippets and doing just slight manipulation of those
 *
...
/**
 * Manipulation of BoundsOptions, which could change the runtime in polynomial time
 * @param random
 */
...
/**
 * @return BoundsOptions as square
 */
...
/**
 *
 * @param random2to5 Already takes a random number between 2 and 5
 * @return BoundsOptions as pow with value random2to5
 */
...
/**
 * @return BoundsOptions as pow with self
 */
...
/**
 * Creates a if statement with a greater condition (used for breaking the loop)
 * -> it tests if the user understands the principle of the loop, consider the if statement
 *   and if he can determine the correct runtime
 * @param random
 * @param innerVar
 */
