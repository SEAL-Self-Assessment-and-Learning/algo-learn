...
export const ifLinear1 = (random: Random, iterDepth: number, finalDepth: number): PseudoCodeIf => {
  return {
    if: {
...
export const ifLinear2 = (random: Random, iterDepth: number, finalDepth: number): PseudoCodeIf => {
  return {
    if: {
...
export const ifLinear3 = (random: Random, iterDepth: number, finalDepth: number): PseudoCodeIf => {
